...
namespace ISXMyWindow
{
	...
	// Save methods
	protected:
		virtual VOID Register(WNDPROC proc, LPCTSTR name, HINSTANCE hinst) const;
		virtual ATOM Register(LPWNDCLASSEX wcex, WNDPROC proc, LPCTSTR name, HINSTANCE hinst) const;
