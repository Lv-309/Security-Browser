...
using namespace ISXVerifyingLink;

VerifyingLink::VerifyingLink(LPCTSTR lpsz_link)
...
std::wstring VerifyingLink::GetProtocol() const noexcept
{
	return this->m_protocol;
}

std::wstring VerifyingLink::GetDomain() const noexcept
{
	return this->m_domain;
}

ErrorTypes VerifyingLink::Verify() const noexcept
{
