...
namespace ISXOleClientSideBrowserGUI
{

	class OleClientSideBrowserGUI
	...
	public:
		...
		typedef		BSTR*			LPBSTR;
		// Constructors
		OleClientSideBrowserGUI(HWND _hwnd_parent);
		~OleClientSideBrowserGUI() = default;
		// Controls 
		bool	CreateBrowser();
		VOID	Refresh()							const;
		VOID	DoPageAction(MSG* msg);
		HRESULT	Navigate(WSTRING sz_url)			const;
	...
	protected:
		...
		CComPtr<IOleInPlaceObject>	m_ole_in_place_object;
	};
}